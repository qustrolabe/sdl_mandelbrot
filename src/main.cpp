...
void setup()
{
    ...
    window = SDL_CreateWindow("sdl_mandelbrot", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, width, height, SDL_WINDOW_OPENGL);
    if (window == nullptr)
...
int main(int argc, char *argv[])
{
    ...
    for(int px = 0;  px < width;  px++)
    {
        for(int py = 0; py < height; py++)
        {
            ...
            SDL_SetRenderDrawColor(renderer, (int) brightness, (int) brightness, (int) brightness, 255);
